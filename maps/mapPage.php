        ...
        <div class="container-lg">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-md-12 text-center">
                    ...
                    <p style="font-size: 22px; text-align:left;"><strong>Map Callouts</strong></p>
                    <p id="map-callouts" style="font-size: 19px; text-align:left;"></p>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="thumbnail-container" id="map-thumbnails"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            ...
                            <form class="comment-form" id="add-comment-form" method="post" action="">
                                ...
                                <textarea name="comment" placeholder="Write your comment here..." id="comment" required></textarea>
