...
$page_id = 'ascent'; // Unique identifier for the page
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span class="breadcrumb"><a href="../index.php">Home</a> >
                        <a href="../maps.php">Maps</a> > Ascent</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-12">
                    <div class="left-image">
                        <img id="main-image" src="../assets/images/ascent.webp" alt="" />
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="thumbnail-container">
                        <img src="../assets/images/ascent.webp" alt="Thumbnail 1" onclick="changeImage('../assets/images/ascent.webp')" />
                        <img style="object-fit: contain;" src="../assets/images/mapslideshow/ascent2.webp" alt="Thumbnail 2" onclick="changeImage('../assets/images/mapslideshow/ascent2.webp')" />
                        <img src="../assets/images/mapslideshow/ascent3.webp" alt="Thumbnail 3" onclick="changeImage('../assets/images/mapslideshow/ascent3.webp')" />
                        <img src="../assets/images/mapslideshow/ascent4.webp" alt="Thumbnail 4" onclick="changeImage('../assets/images/mapslideshow/ascent4.webp')" />
                        <img src="../assets/images/mapslideshow/ascent5.webp" alt="Thumbnail 5" onclick="changeImage('../assets/images/mapslideshow/ascent5.webp')" />
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            ...
                            <form class="comment-form" id=add-comment-form>
                                <input type="hidden" name="page_id" value="ascent">
                                <p>
